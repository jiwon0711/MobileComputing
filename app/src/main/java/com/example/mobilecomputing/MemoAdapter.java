...
public class MemoAdapter extends RecyclerView.Adapter<MemoAdapter.ViewHolder> {
    ...
    public MemoAdapter(MainActivity context) {
        mcontext = context;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final MemoAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
